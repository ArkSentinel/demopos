class CategoriesController < ApplicationController
  ...
  def create_multiple
    categories_params[:categories].each do |category_data|
      Category.create(category_data.permit(:name))
    end
    render json: { message: "Categorías creadas correctamente" }, status: :created
  end
